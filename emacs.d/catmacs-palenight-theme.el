;;; catmacs-palenight-theme.el --- inspired by Material-PaleNight -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup catmacs-palenight-theme nil
  "Options for the `catmacs-palenight' theme."
  :group 'doom-themes)

(defcustom doom-palenight-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'catmacs-palenight-theme
  :type '(choice integer boolean))

;;
(def-doom-theme catmacs-palenight
  "A variation on doom emacs dark theme inspired by Material-Palenight"
...
;;; catmacs-palenight-theme.el ends here
